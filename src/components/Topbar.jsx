...
const Topbar = () => {
  ...
  return (
    <nav className="w-full bg-neutral-900 fixed z-50 px-8 min-h-[10vh] py-2 pt-3 mb-4 drop-shadow-lg">
      <div className="max-w-screen-xl bg-neutral-900 flex flex-wrap items-center justify-between mx-auto p-4">
